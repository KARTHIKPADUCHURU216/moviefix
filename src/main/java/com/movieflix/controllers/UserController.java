...
public class UserController {
	...
	@RequestMapping("deleteuser-map")
	@DeleteMapping(value="{id}")
	
	public String deleteuser(@RequestParam int id ) {
		
		boolean status = userv.deleteUser(id);
	...
	public String updatename(@ModelAttribute User user, HttpSession session) {
		
		String email = (String)session.getAttribute("email");

		userv.updateUser(user,email);
